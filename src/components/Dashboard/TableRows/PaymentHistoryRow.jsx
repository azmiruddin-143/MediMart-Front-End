            ...
            <tr className='text-neutral'>
                ...
                <td className='text-neutral border border-gray-300 px-4 py-2 '>
                    <div className='justify-end flex '>
                        <button disabled={status === "Paid"} onClick={acceptPayment} className={`${status === "Pending" ? 'bg-primary justify-end flex items-center gap-0 py-2 px-4 rounded-full font-bold text-[black]' : "bg-[#f1f1f1] justify-end text-[#979797] flex items-center gap-0 py-2 px-4 rounded-full "}`}  >
                            Accept
