...
const Navbar = () => {
    ...
    return (
        <div
            className={`sticky top-0 w-full z-40 transition-all duration-300 ${isBlurred ? "bg-[#07060995] backdrop-blur-md " : "bg-[#ad7925]"
                }`}
        >
                    ...
                    <div className="navbar-start">
                        <div className="dropdown">
                            ...
                            >
                                <svg
                                    ...
                                    className={`${isBlurred && "text-black"} text-black sm:h-8 sm:w-8 h-6 w-6`}
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                >
                            ...
                            {isDropdownOpen && (
                                <ul
                                    tabIndex={0}
                                    className="menu menu-sm dropdown-content gap-4 text-black bg-primary rounded-box z-[1] mt-3 w-44 sm:w-52 py-6 px-2 shadow"
                                >
                        ...
                        <Link to={'/'} >
                            <div className='flex items-center gap-0 sm:gap-3'>
                                ...
                                <h1 className={`${isBlurred && "text-black font-bold"} sm:text-3xl text-[12px] pl-2 lg:pl-0 lg:text-xl xl:text-3xl text-black font-bold`}> FoodFusion
                                </h1>
                            </div>
                        </Link>
                    </div>
                    ...
                    <div className="navbar-center  xl:ml-10 2xl:ml-0 hidden lg:flex">
                        <ul className={`${isBlurred ? "xl:text-lg text-md text-black flex gap-3 sm:gap-6 xl:gap-8" : "xl:text-lg text-md text-black  flex gap-3 sm:gap-6 xl:gap-8"}`}>
                            <NavLink
                                ...
                                className={({ isActive }) =>
                                    isActive
                                        ? `${isBlurred ? "text-white font-bold border-b border-secondary" : "text-white border-b border-white"}`
                                        : ""
                                }
                            >
                                Home
                                    ...
                                    <div className="relative flex justify-center items-center group w-[50px] sm:w-[70px] h-[70px]">

                                        {
                                            ...
                                            <div className="dropdown dropdown-end">
                                                ...
                                                <ul
                                                    tabIndex={0}
                                                    className="menu menu-sm dropdown-content text-black bg-primary space-y-3 rounded-box z-[1] mt-3 w-52 p-2 shadow">
