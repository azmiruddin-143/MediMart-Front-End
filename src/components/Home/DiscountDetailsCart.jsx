            ...
            <div>
                ...
                <div className='space-y-3 my-4 text-md'>
                    ...
                    <div className='flex justify-between items-center'>
                        ...
                        <button disabled={role === "Admin" || role === "Seller"} onClick={cartDiscount}  className='rounded-full bg-primary px-3 py-2 font-semibold text-black text-end flex items-center justify-center'>
